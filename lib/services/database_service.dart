    ...
    return _tasks.where((t) {
      ...
      if (search != null && search.isNotEmpty) {
        ...
        if (!t.title.toLowerCase().contains(q) &&
            ...
            !t.location.toLowerCase().contains(q)) return false;
      }
      return true;
    }).toList()
  ...
  void _seedData() {
    ...
    _tasks.addAll([
      Task(
        ...
        description: 'Join us for a morning beach clean-up at Sarıyer coast. We will collect plastic waste and debris along 2km of shoreline. Gloves and bags provided. Great opportunity to meet like-minded people and make a real difference!',
      ...
      Task(
        ...
        description: 'Help us care for rescued dogs and cats at our Istanbul shelter. Activities include feeding, grooming, socializing animals, and assisting with adoption events. Animal lovers welcome — no experience needed, just a big heart!',
      ...
      Task(
        ...
        description: 'We need volunteer tutors to provide free math lessons to middle school students from low-income families. Sessions are held every Saturday morning for 2 hours. Experience in teaching or education preferred.',
      ...
      Task(
        ...
        description: 'Assist with sorting and distributing food packages at our weekly food bank. We serve over 200 families each week and need helping hands for packing, organizing, and distribution logistics.',
        organizationId: 'org_1',
        organizationName: 'Temiz Deniz Derneği',
        category: 'Social',
      ...
      Task(
        ...
        description: 'We are looking for a volunteer photographer to document our annual gala dinner. This is a great opportunity to build your portfolio while supporting a great cause. Professional equipment preferred.',
        organizationId: 'org_3',
        organizationName: 'Çocuk Eğitim Vakfı',
        category: 'Arts & Media',
      ...
      Task(
        ...
        description: 'Help us plant 500 trees at Polonezköy Nature Park. Shovels and saplings provided. Wear comfortable clothes and bring water. Lunch will be served. A great family-friendly activity!',
        organizationId: 'org_1',
        organizationName: 'Temiz Deniz Derneği',
        category: 'Environment',
      ...
      Task(
        ...
        description: 'Assist veterinarians during a free vaccination and neutering campaign for stray cats in Üsküdar. Tasks include handling cats, record keeping, and community outreach.',
        organizationId: 'org_2',
        organizationName: 'Patiler Kurtarma Derneği',
        category: 'Animals',
    ...
    _applications.add(TaskApplication(
      id: 'app_seed_1',
      taskId: 'task_1',
      userId: 'vol_1',
