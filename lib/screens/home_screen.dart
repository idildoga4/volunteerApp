...
class _HomeScreenState extends State<HomeScreen> {
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: sel ? AppTheme.primary : Theme.of(context).cardColor,
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    _statItem(context, '${db.getTasks(onlyOpen: true).length}', 'Open Tasks'),

                    _vDivider(context),

                    _statItem(context, '${AppConstants.categories.length - 1}', 'Categories'),
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (_, i) => TaskCard(
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (_) => TaskDetailScreen(taskId: tasks[i].id))).then((_) {
                              setState(() {});
                            });
                          },
                        ),
    ...
    return Column(
      children: [
        Text(
          ...
          style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: Theme.of(context).cardColor),
        ),
        ...
        Text(
          ...
          style: TextStyle(fontSize: 11, color: Theme.of(context).cardColor.withOpacity(0.75), fontWeight: FontWeight.w500),
        ),
      ],
    );
  }
  ...
  Widget _vDivider(BuildContext context) {
    return Container(width: 1, height: 32, color: Theme.of(context).cardColor.withOpacity(0.2));
  }
}
